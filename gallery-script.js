...
function gfxSlides(){
    if (currentSlide == 1){
        gfxIndicators.item(2).setAttribute("style","background-color: rgba(40, 60, 79, 0.4);");
        gfxIndicators.item(1).setAttribute("style","background-color: rgba(40, 60, 79, 0.4);");
        gfxIndicators.item(0).setAttribute("style","background-color: rgba(40, 60, 79, 1.0);");
    ...
    if (currentSlide == 2){
        gfxIndicators.item(currentSlide).setAttribute("style","background-color: rgba(40, 60, 79, 0.4);");
        gfxIndicators.item(currentSlide - 2).setAttribute("style","background-color: rgba(40, 60, 79, 0.4);");
        gfxIndicators.item(currentSlide - 1).setAttribute("style","background-color: rgba(40, 60, 79, 1.0);");
    ...
    if (currentSlide == 3){
        gfxIndicators.item(currentSlide - 3).setAttribute("style","background-color: rgba(40, 60, 79, 0.4);");
        gfxIndicators.item(currentSlide - 2).setAttribute("style","background-color: rgba(40, 60, 79, 0.4);");
        gfxIndicators.item(currentSlide - 1).setAttribute("style","background-color: rgba(40, 60, 79, 1.0);");
...
function gitSlides(){
    if (currentSlide == 1){
        gitIndicators.item(1).setAttribute("style","background-color: rgba(32, 84, 79, 0.4);");
        gitIndicators.item(0).setAttribute("style","background-color: rgba(32, 84, 79, 1.0);");

        git_slides.item(0).setAttribute("style", "display: block");
        git_slides.item(1).setAttribute("style", "display: none");
    };
    if (currentSlide == 2){
        gitIndicators.item(currentSlide - 2).setAttribute("style","background-color: rgba(32, 84, 79, 0.4);");
        gitIndicators.item(currentSlide - 1).setAttribute("style","background-color: rgba(32, 84, 79, 1.0);");
...
function datavisSlides(){
    if (currentSlide == 1){
        datavisIndicators.item(2).setAttribute("style","background-color: rgba(166, 93, 66, 0.4);");
        datavisIndicators.item(1).setAttribute("style","background-color: rgba(166, 93, 66, 0.4);");
        datavisIndicators.item(0).setAttribute("style","background-color: rgba(166, 93, 66, 1.0);");
    ...
    if (currentSlide == 2){
        datavisIndicators.item(currentSlide).setAttribute("style","background-color: rgba(166, 93, 66, 0.4);");
        datavisIndicators.item(currentSlide - 2).setAttribute("style","background-color: rgba(166, 93, 66, 0.4);");
        datavisIndicators.item(currentSlide - 1).setAttribute("style","background-color: rgba(166, 93, 66, 1.0);");
    ...
    if (currentSlide == 3){
        datavisIndicators.item(currentSlide - 3).setAttribute("style","background-color: rgba(166, 93, 66, 0.4);");
        datavisIndicators.item(currentSlide - 2).setAttribute("style","background-color: rgba(166, 93, 66, 0.4);");
        datavisIndicators.item(currentSlide - 1).setAttribute("style","background-color: rgba(166, 93, 66, 1.0);");
